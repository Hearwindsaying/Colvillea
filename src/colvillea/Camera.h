...
/*! the entire state for something that can 'control' a camera -
        i.e., that can rotate, move, focus, force-up, etc, a
...
struct Camera
{
    ...
    /*! multiplier how fast the camera should move in world space
          for each unit of "user specified motion" (i.e., pixel
...
{
    CameraManipulator(CLViewer* viewer) :
        viewer(viewer) {}
